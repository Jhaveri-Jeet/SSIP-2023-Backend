...
namespace CriminalDatabaseBackend.Migrations
{
    ...
    [Migration("20231111090245_evidencetableadded")]
    partial class evidencetableadded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CriminalDatabaseBackend.Features.Cases.Cases", b =>
                {
                    ...
                    b.HasOne("CriminalDatabaseBackend.Features.Roles.Roles", "TransferFrom")
                        .WithMany()
                        .HasForeignKey("TransferFromId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CriminalDatabaseBackend.Features.Roles.Roles", "TransferTo")
                        .WithMany()
